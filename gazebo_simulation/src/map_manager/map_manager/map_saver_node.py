...
class MapSaverNode(Node):
    ...
    def __init__(self):
        ...
        # Default map directory for simulation
        self.map_dir = os.path.expanduser("~/delivery_bot_ws/gazebo_simulation/data/maps")
        ...
        if self.active_service_type == 'nav2':
            ...
            try:
                ...
                possible_locations = [
                    ...
                    (os.path.expanduser("~/delivery_bot_ws/gazebo_simulation"), "gazebo simulation workspace root"),
