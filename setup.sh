...
echo "  ros2 launch launch/location_tagging_gui.launch.py  # Location tagging GUI (recommended)"
echo "  ros2 run location_manager location_tag_gui        # Location tagging GUI (alternative)"
echo "  ros2 run location_manager location_tag_node       # Location tagging CLI"
